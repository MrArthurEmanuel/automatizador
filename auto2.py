...
class Automacao:
    def __init__(self):
        ...
        layout = [
            ...
            [sg.Text('                    Operador(a)', font=('Impact', '15'))],
            [sg.Combo(['Arthur', 'Lucas', 'Isa', 'Aninha'], enable_events=True,key='user',expand_x=True)],
    ...
    def Iniciar(self):
        while True:
            ...
            if eventos == 'Tutorial de uso':
                ...
                \n2 - Escolha seu nome ali no campo "Operador" (É só um charminho)
